...
public class TestAllSolveur {
    ...
    /**
     * Lecture de tous les noms des instances a tester. Ces instances se trouvent
     * dans le repertoire pathRepertoire. Les instances sont lues et chargees en
     * memoire.
     */
    ...
    /**
     * Affichage de tous les resultats. Les resultats sont affiches dans un fichier
     * csv avec separateur ';'.
     * 
    ...
    /**
     * Affichage de la somme des resultats par solveur. Les valeurs sont ecrites sur
     * une seule ligne.
     * 
     ...
     * solveur, l'instance est resolue par le solveeur avant que ses resultats ne
     * soient ecrits sur le fichier.
     * 
     * @param ecriture le writer sur lequel on fait l'ecriture
    ...
    private void printResultatsInstance(PrintWriter ecriture, Instance inst) {
        ...
        for (Solveur solveur : solveurs) {
            ...
            Resultat result = new Resultat(sol.getTotalCost(), time, true);
    ...
    /**
     * Cette classe interne represente le resultat a ecrire lorsqu'une instance a
     * ete resolue.
     */
    class Resultat {
        /**
        ...
        /**
         * @return le resultat formatte avec separateur ';' pour erire dans un fichier
         *         csv
         */
        public String formatCsv() {
            return formatSepMilliers(this.cout) + ";" + formatSepMilliers(this.timeInMs) + ";" + check;
        }
         ...
         * @return s avec des '0' au ebut si sa taille initiale etait infeieure a 3
         */
